...
public class StationRimActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_rim);
        immersion();
        initViews();
        initEvents();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_sure:
                startActivity(new Intent(this,StationRimSureActivity.class));
                break;
